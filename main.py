...
if sys.platform == 'darwin':
    os.system("docker run -t -d --expose=5432 -v ~/research/dap:/dap -v ~/research/dap_data:/dap_data -v ~/research/dap_index_files:/dap_index_files --name b_insert_wcs b_insert_wcs")
else:
