...
#os.system("docker stop tylerlinder/b_insert_wcs")
os.system("docker stop b_insert_wcs")

#os.system("docker rm tylerlinder/b_insert_wcs")
...
#os.system("docker run -t -d -v ~/research/dap:/dap -v ~/research/dap_data:/dap_data -v ~/research/dap_index_files:/dap_index_files --name b_insert_wcs b_insert_wcs")

os.system("docker exec -it b_insert_wcs bash")


#os.system("docker push tylerlinder/b_insert_wcs")
